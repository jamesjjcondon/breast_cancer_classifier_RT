...
def main():
    ...
    parser.add_argument('--data-path',
                        default=os.path.join(
                                DATADIR, 'test_ims_master/NY_16-8pc_incidence/data_sf2.pkl'))
    parser.add_argument('--image-path',
                        default=os.path.join(
                                DATADIR, 'test_ims_master/NY_16-8pc_incidence/cropped_images_sf2'))
    parser.add_argument('--output-path',
                        default=os.path.join(
                                DATADIR, 'test_ims_master/NY_16-8pc_incidence/NYU_model_sf2/imageheatmaps_predictions_16-8pi_v2-1_full.csv'
                                             )
                        )
    ...
    parser.add_argument('--heatmaps-path',
                        default=os.path.join(
                                DATADIR, 'test_ims_master/NY_16-8pc_incidence/heatmaps_sf2'))
