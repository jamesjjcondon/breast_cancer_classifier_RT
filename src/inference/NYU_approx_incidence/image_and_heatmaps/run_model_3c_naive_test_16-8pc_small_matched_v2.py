...
def main():
    ...
    parser.add_argument('--data-path',
                        default=os.path.join(
                                DATADIR, 'test_ims_master/NY_16-8pc_incidence/small_matched/data_NY16_sf_small_NYUC_matched.pkl'))
    parser.add_argument('--image-path',
                        default=os.path.join(
                                DATADIR, 'test_ims_master/NY_16-8pc_incidence/small_matched/cropped_NY16_ims_NYU_small'))
    parser.add_argument('--output-path',
                        default=os.path.join(
                                DATADIR, 'test_ims_master/preds/small_matched_16pc_incidence_3c_naive_preds.csv'
                                             )
                        )
    ...
    parser.add_argument('--heatmaps-path',
                        default=os.path.join(
                                DATADIR, 'test_ims_master/NY_16-8pc_incidence/small_matched/heatmaps_NY16_sf_small_matched'))
