...
def main():
    ...
    parser.add_argument('--data-path',
                        default=os.path.join(DATADIR, 'test_ims_master/med_matched/data_NYU_center_sf_med_matched.pkl'))
    parser.add_argument('--image-path',
                        default=os.path.join(DATADIR, 'test_ims_master/med_matched/cropped_ims_NYU_med'))
    parser.add_argument('--output-path',
                        default=os.path.join(DATADIR,
                                             'test_ims_master/med_matched/naive_balanced_sfmed_3c_NYUC_preds_v1.csv'
                                             )
                        )
    ...
    parser.add_argument('--heatmaps-path',
                        default=os.path.join(DATADIR, 'test_ims_master/med_matched/heatmaps_sf_med_matched'))
