...
def main():
    ...
    parser.add_argument('--data-path',
                        default=os.path.join(DATADIR, 'val_ims_master/small_matched/data_NYUC_sf_small_matched.pkl'))
    parser.add_argument('--image-path',
                        default=os.path.join(DATADIR, 'val_ims_master/small_matched/cropped_ims_NYU_small'))
    parser.add_argument('--output-path',
                        default=os.path.join(DATADIR,
                                             'val_ims_master/small_matched/naive_balanced_sfsmall_3c_NYUC_preds_val_v1.csv'
                                             )
                        )
    ...
    parser.add_argument('--heatmaps-path',
                        default=os.path.join(DATADIR, 'val_ims_master/small_matched/heatmaps_sf_small_matched'))
