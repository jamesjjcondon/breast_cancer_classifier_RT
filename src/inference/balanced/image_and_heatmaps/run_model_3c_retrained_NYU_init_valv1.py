...
def main():
    ...
    parser.add_argument('--data-path',
                        default=os.path.join(NVMEDIR, 'val_ims_master/data_sf2.pkl'))
    parser.add_argument('--image-path',
                        default=os.path.join(NVMEDIR, 'val_ims_master/cropped_images_sf2'))
    parser.add_argument('--output-path',
                        default=os.path.join(NVMEDIR,
                                             'val_ims_master/5050_preds_sf2/retrained-3-channel/imageheatmaps_predictions_v2.csv'
                                             )
                        )
    ...
    parser.add_argument('--heatmaps-path',
                        default=os.path.join(NVMEDIR, 'val_ims_master/heatmaps_sf2'))
