...
def main():
    ...
    parser.add_argument('--data-path',
                        default=os.path.join(DATADIR, 'val_ims_master/large_matched/data_sf_large_NYUC_matched.pkl'))
    parser.add_argument('--image-path',
                        default=os.path.join(DATADIR, 'val_ims_master/large_matched/cropped_ims_NYU_large'))
    parser.add_argument('--output-path',
                        default=os.path.join(DATADIR,
                                             'val_ims_master/large_matched/naive_bal_large_c3_preds_val_v1.csv'
                                             )
                        )
    ...
    parser.add_argument('--heatmaps-path',
                        default=os.path.join(DATADIR, 'val_ims_master/large_matched/heatmaps_sf_large_matched'))
