...
# ==============================================================================
"""
Runs the image + heatmaps model, trained from scratch / random weight initialisation for breast cancer prediction on BSSA data.
Defaults preset below to run without .sh

Uses best model for balanced validation set loss.
...
def main():
    ...
    parser.add_argument('--model-path',
                        default=os.path.join(DATADIR,
                                             'logs/from_scratch/NYU2/NYURT_2021-02-19/version_0/checkpoints/epoch=131-train_loss_epoch=2.046-val_loss_epoch=2.000.ckpt'))
    ...
    parser.add_argument('--output-path',
                        default=os.path.join(DATADIR,
                                             'test_ims_master/preds/small_matched_3c_from_scratch_preds.csv'
                                             )
                        )
