...
from src.constants import DATADIR, REPODIR, NVMEDIR, VIEWS, VIEWANGLES, LABELS, MODELMODES
...
def main():
    ...
    parser.add_argument('--model-path',
                        default=os.path.join(REPODIR,
                                             'models/sample_imageheatmaps_model.p'
                                             )
                        )
    parser.add_argument('--data-path',
                        default=os.path.join(DATADIR, 'test_ims_master/large_matched/data_sf_large_matched.pkl'))
    parser.add_argument('--image-path',
                        default=os.path.join(DATADIR, 'test_ims_master/large_matched/cropped_images_sf_matched_large'))
    parser.add_argument('--output-path',
                        default=os.path.join(DATADIR,
                                             'test_ims_master/large_matched/naive_balanced_sf_large_imageheatmaps_predictions_v1.csv'
                                             )
                        )
    ...
    parser.add_argument('--heatmaps-path',
                        default=os.path.join(DATADIR, 'test_ims_master/large_matched/heatmaps_sf_large_matched'))
    ...
    parser.add_argument('--retrained', action='store_true', default=False)
