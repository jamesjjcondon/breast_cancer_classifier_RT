...
def main():
    ...
    parser.add_argument('--model-path',
                        default=os.path.join(DATADIR,
                                             'drjc_models_and_logs/NYU2/from_scratch/01NOV_HMs_rand_init_v1_epo=46_tloss=2.701_avloss=2.122.ckpt'
                                             )
                        )
    ...
    parser.add_argument('--output-path',
                        default=os.path.join(DATADIR,
                                             'test_ims_master/balanced_preds_sf2/NYU2/from_scratch/imageheatmaps_predictions_from_scratch.csv'
                                             )
                        )
