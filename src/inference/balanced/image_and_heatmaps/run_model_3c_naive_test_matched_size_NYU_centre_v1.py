...
def main():
    ...
    parser.add_argument('--data-path',
                        default=os.path.join(DATADIR, 'test_ims_master/size_matched/data_sf_matched_NYU_centre.pkl'))
    parser.add_argument('--image-path',
                        default=os.path.join(DATADIR, 'test_ims_master/size_matched/cropped_images_sf_matched'))
    parser.add_argument('--output-path',
                        default=os.path.join(DATADIR,
                                             'test_ims_master/size_matched/NYU2/naive/naive_imageheatmaps_preds_size_matched_NYU_centre_v1.csv'
                                             )
                        )
    ...
    parser.add_argument('--heatmaps-path',
                        default=os.path.join(DATADIR, 'test_ims_master/size_matched/heatmaps_sf_matched'))
