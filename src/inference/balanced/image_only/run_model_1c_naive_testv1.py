...
# ==============================================================================
"""
Runs the ('naive') NYU1 image only model for breast cancer prediction on BSSA data.
...
def main():
    ...
    parser.add_argument('--output-path',
                        default=os.path.join(DATADIR,
                                             'test_ims_master/balanced_preds_sf2/NYU1/naive/naive_image_predictions_v2.csv'
                                             )
                        )
    ...
    parser.add_argument('--heatmaps-path',
                        default=os.path.join(DATADIR, 'test_ims_master/heatmaps_sf2'))
