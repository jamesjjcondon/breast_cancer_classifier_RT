...
# ==============================================================================
"""
Runs the image only model for breast cancer prediction on BSSA data.
Defaults preset to run without .sh script
"""  
import argparse
...
def load_model(parameters):
    ...
    if parameters['retrained']:
        ...
        model = model_class(parameters) #['input_channels'])
...
#                                             'dev_test_models/1-channel/ckpts_24May_2GPU_V6/24May_2GPU_V6_epo=50_tloss=1.780_avloss=2.689.ckpt'
#                                             ),
                        default='/data/james/NYU_retrain/dev_test_models/1-channel/ckpts_Redo_12NOV_V1/Redo_12NOV_V1_epo=81_tloss=1.227_avloss=2.295.ckpt'
                        )
    parser.add_argument('--data-path',
#                        default='/home/mlim-user/Documents/james/NYU_retrain_SSD/val_ims_sf2/data_sf2.pkl')
                        default=os.path.join(DATADIR, 'test_ims_master/data_sf2.pkl'))
    parser.add_argument('--image-path',
                        default=os.path.join(DATADIR, 'test_ims_master/cropped_images_sf2'))
...
#                                             'test_ims_master/5050_preds_sf2/Fine-tuned-1-channel/image_predictions.csv'
#                                             )
                        default='/data/james/NYU_retrain/test_ims_master/balanced_preds_sf2/NYU1/from_scratch/NYU1_scratch_image_predictions_v2.csv'
                        )
    ...
    parameters = {
        ...
        "input_channels": 3 if args.use_heatmaps else 1,
