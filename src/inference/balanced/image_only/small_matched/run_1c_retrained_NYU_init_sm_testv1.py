...
# ==============================================================================
"""
Runs the retrained image only model for breast cancer prediction on BSSA data.
Model trained with NYU weight initialisation / transfer learning.
Defaults preset below to run without .sh

Uses 
'~/logs/transfer_learning/NYU1/NYURT_2021-02-28/version_0/checkpoints/epoch=163-train_loss_epoch=2.230-val_loss_epoch=2.270.ckpt
...
def main():
    ...
    parser.add_argument('--output-path',
                        default=os.path.join(DATADIR,
                                             'test_ims_master/preds/small_matched_1c_NYU_init_preds.csv'
                                             )
                        )
