...
def main():
    ...
    parser.add_argument('--model-path',
                        default=os.path.join(DATADIR,
                                             'logs/from_scratch/NYU1/NYURT_2021-03-04/version_0/checkpoints/epoch=143-train_loss_epoch=2.653-val_loss_epoch=2.628.ckpt'))
    ...
    parser.add_argument('--output-path',
                        default=os.path.join(DATADIR,
                                             'test_ims_master/preds/small_matched_1c_from_scratch_preds.csv'
                                             )
                        )
