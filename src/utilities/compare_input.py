...
all_BSSA_exams = pickling.unpickle_from_file(
        '/data/james/NYU_Retrain/test_ims_master/test_ims_mini/pre_crop_exam_list.pkl'
        )
...
NYU_im_fp = '/home/james/mydev/breast_cancer_classifier/sample_data/images'
BSSA_im_fp = '/data/james/NYU_Retrain/test_ims_master/test_ims_mini/size_matched/cropped_images_sf_matched'
...
#        show(bim, figsize=(10,10))
        ...
        if nim.shape[0] > bim.shape[0]:
            show_2(bim, nim, title=title, stitle1='SA. size: '+str(bim.shape), stitle2='NYU. size: '+str(nim.shape), figsize=(20,20))
        else:
            show_2(nim, bim, title=title, stitle1='NYU. size: '+str(nim.shape), stitle2='SA. size: '+str(bim.shape), figsize=(20,20))
        input()
