...
def main(hparams):
    ...
    trainer = Trainer(
        ...
        benchmark=True,
        callbacks=[ckpt_callback, early_stop_callback, timer],
...
if __name__ == '__main__':
    ...
    if hparams.rand_init:
        assert hparams.restore is None, "Either rand_init or restore from checkpoint, not both"
