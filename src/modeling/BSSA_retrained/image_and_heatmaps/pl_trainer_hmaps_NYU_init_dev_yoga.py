...
def main(hparams):
    ...
    logger = TestTubeLogger(save_dir=os.path.join(DATADIR, 'logs/from_scratch/NYU2'),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--accel', type=str, default='ddp_cpu')
    ...
    parser.add_argument('--overfit_batches', default=6)
    ...
    parser.add_argument('--train_exam_list_fp', type=str, default=os.path.join(NVMEDIR, 'train_ims_mini/data.pkl'))
    parser.add_argument('--train_heatmaps_path', type=str, default=os.path.join(NVMEDIR, 'train_ims_mini/heatmaps'))
    parser.add_argument('--train_image_path', type=str, default=os.path.join(NVMEDIR, 'train_ims_mini/cropped_images'))
    ...
    parser.add_argument('--val_exam_list_fp', type=str, default=os.path.join(NVMEDIR, 'train_ims_mini/data.pkl'))
    parser.add_argument('--val_heatmaps_path', type=str, default=os.path.join(NVMEDIR, 'train_ims_mini/heatmaps'))
    parser.add_argument('--val_image_path', type=str, default=os.path.join(NVMEDIR, 'train_ims_mini/cropped_images'))
    parser.add_argument('--weight_decay', type=float, default=4e-05)
