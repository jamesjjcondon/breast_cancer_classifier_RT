...
if __name__ == '__main__':
    ...
    parser.add_argument('--restore', type=str, #default=None)
                        default='/data/james/NYU_retrain/logs/transfer_learning/NYU2/NYURT_2021-03-04/version_0/checkpoints/epoch=75-train_loss_epoch=2.086-val_loss_epoch=1.971.ckpt'
                        )
