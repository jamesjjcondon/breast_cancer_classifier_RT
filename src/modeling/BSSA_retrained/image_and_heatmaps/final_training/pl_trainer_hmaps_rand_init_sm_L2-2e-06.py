...
if __name__ == '__main__':
    ...
    parser.add_argument('--restore', type=str, default=None)
                        #default='/data/james/NYU_retrain/logs/from_scratch/NYU2/NYURT_2021-02-19/version_0/checkpoints/epoch=148-train_loss_epoch=2.026-val_loss_epoch=2.004.ckpt'
                        )   
