...
from src.utilities.callbacks import timer
...
def main(hparams):
    ...
    logger = TestTubeLogger(save_dir=os.path.join(DATADIR, 'logs/transfer_learning/NYU2/final'),
            name='NYURT_noL2_'+date_time)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default=0.00001) #0.0007585775750291836) # if using cyclic schedule == triangular, bottom of cycle/min
    ...
    parser.add_argument('--restore', type=str, #default=None)
                        default='/data/james/NYU_retrain/logs/transfer_learning/NYU2/NYURT_2021-03-04/version_0/checkpoints/epoch=67-train_loss_epoch=2.035-val_loss_epoch=1.976.ckpt'
                        )
