...
if __name__ == '__main__':
    ...
    parser.add_argument('--val_exam_list_fp', type=str, default=os.path.join(NVMEDIR, 'val_ims_mini/data.pkl'))
    parser.add_argument('--val_heatmaps_path', type=str, default=os.path.join(NVMEDIR, 'val_ims_mini/heatmaps'))
    parser.add_argument('--val_image_path', type=str, default=os.path.join(NVMEDIR, 'val_ims_mini/cropped_images'))
