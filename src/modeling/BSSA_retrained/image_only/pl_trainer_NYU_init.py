...
def main(hparams):
    ...
    logger = TestTubeLogger(
            ...
            description="exp_range 0.75 for cyclic lr_sched",
            debug=False,
            version=None)
...
if __name__ == '__main__':
   ...
   # parser.add_argument('--model_path', type=str, default=os.path.join(REPODIR, '/models/sample_image_model.p'))
