...
def main(hparams):
    ...
    logger = TestTubeLogger(save_dir=os.path.join(DATADIR, 'logs/from_scratch/NYU1'),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--restore', type=str, #default=None)
                        default='/data/james/NYU_retrain/logs/from_scratch/NYU1/NYURT_2021-03-03/version_1/checkpoints/epoch=135-train_loss_epoch=2.724-val_loss_epoch=2.630.ckpt'
                        )   
