...
def main(hparams):
    ...
    logger = TestTubeLogger(save_dir=os.path.join(DATADIR, 'logs/from_scratch/NYU1/final'),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default=0.00007585775750291836) # if using cyclic schedule == triangular, bottom of cycle/min
    ...
    parser.add_argument('--rand_init', action='store_true', default=False) #restarting:
    parser.add_argument('--restore', type=str, #default=None)
                        default='/data/james/NYU_retrain/logs/from_scratch/NYU1/final/NYURT_2021-03-16/version_0/checkpoints/epoch=169-train_loss_epoch=2.704-val_loss_epoch=2.631.ckpt'
                        )   
    ...
    parser.add_argument('--weight_decay', type=float, default=0) #2e-06)
