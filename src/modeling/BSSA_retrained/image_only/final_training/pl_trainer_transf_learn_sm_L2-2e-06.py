...
def main(hparams):
    ...
    logger = TestTubeLogger(save_dir=os.path.join(DATADIR, 'logs/transfer_learning/NYU1'),
    ...
    if hparams.rand_init:
        ...
        model.load_state_dict(
                torch.load(hparams.model_path)["model"]
                )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--restore', type=str,
        default='/data/james/NYU_retrain/logs/transfer_learning/NYU1/NYURT_2021-02-26/version_1/checkpoints/epoch=155-train_loss_epoch=2.218-val_loss_epoch=2.272.ckpt')
