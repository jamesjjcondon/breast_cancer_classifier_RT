...
BASE_PATH='/home/james/Documents/mydev/nyukat2.0'
PATCH_MODEL_PATH=$BASE_PATH/'models/sample_patch_model.p'
IMAGE_MODEL_PATH=$BASE_PATH/'models/ImageOnly__ModeImage_weights.p'
IMAGEHEATMAPS_MODEL_PATH=$BASE_PATH/'models/ImageHeatmaps__ModeImage_weights.p'

SAMPLE_SINGLE_OUTPUT_PATH='/Data/james/NYU_val'
